...
final class ExporterTests: XCTestCase, XCTestHelper {
    ...
    func testsXmlExporter() throws {
        ...
        XCTAssertNotEqual(nil, data)
        let result =
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><root><row id=\"1\" name=\"&quot;Tatsuya Hotta\" birthday=\"1974/03/15\"></row><row id=\"2\" name=\"Riho, Yoshioka\" birthday=\"1993/01/15\"></row><row id=\"3\" name=\"Kana\r\nKurashina\" birthday=\"1987/12/23\"></row><row id=\"4\" name=\"Kanna Hashimoto\" birthday=\"1999/02/03\"></row></root>"
        XCTAssertEqual(result, String(data: data!, encoding: .utf8)!)
    ...
    private func getRows() -> AnySequence<[Any]> {
        ...
        formatter.dateFormat = DateFormatter.dateFormat(
            fromTemplate: "yyyy/MM/dd", options: 0, locale: Locale(identifier: "ja_JP"))
        let data = [
